...
def get_argparse():
    ...
    parser.add_argument(
        ...
        "--results_dir",
        type=str,
        default=f"{DEFAULT_NPZ_DIR}/scene_list__challenge_phase_testing_set",#scene_list__warm_up_pilot_set",
    ...
    parser.add_argument(
        "-f",
        "--scene_list",
        default=f"{SCENE_LIST_DIR}/scene_list__challenge_phase_testing_set.json",#f"{SCENE_LIST_DIR}/scene_list__warm_up_pilot_set.json",
